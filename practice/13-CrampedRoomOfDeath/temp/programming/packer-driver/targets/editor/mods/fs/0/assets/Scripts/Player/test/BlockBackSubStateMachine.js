System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, DirectionSubStateMachine, DIRECTION_ENUM, State, BlockBackSubStateMachine, _crd, BASE_URL;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "1ada5KTd7xMdr2DDlq4nefC", "BlockBackSubStateMachine", undefined);

      BASE_URL = 'texture/player/blockback';

      _export("default", BlockBackSubStateMachine = class BlockBackSubStateMachine extends (_crd && DirectionSubStateMachine === void 0 ? (_reportPossibleCrUseOfDirectionSubStateMachine({
        error: Error()
...
//# sourceMappingURL=BlockBackSubStateMachine.js.map