System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, DirectionSubStateMachine, DIRECTION_ENUM, State, TurnLeftSubStateMachine, _crd, BASE_URL;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "e8831tv4YxNsrP4yymA60Fo", "TurnLeftSubStateMachine", undefined);

      BASE_URL = 'texture/player/turnleft';

      _export("default", TurnLeftSubStateMachine = class TurnLeftSubStateMachine extends (_crd && DirectionSubStateMachine === void 0 ? (_reportPossibleCrUseOfDirectionSubStateMachine({
        error: Error()
...
//# sourceMappingURL=TurnLeftSubStateMachine.js.map