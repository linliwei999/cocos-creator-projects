  ...
  return {
    ...
    execute: function () {
      ...
      _export("BurstManager", BurstManager = (_dec = ccclass('BurstManager'), _dec(_class = class BurstManager extends (_crd && EntityManager === void 0 ? (_reportPossibleCrUseOfEntityManager({
        ...
        async init(params) {
          this.fsm = this.node.addComponent(_crd && BurstStateMachine === void 0 ? (_reportPossibleCrUseOfBurstStateMachine({
            error: Error()
          ...
          (_crd && EventManager === void 0 ? (_reportPossibleCrUseOfEventManager({
            ...
            error: Error()
          }), EVENT_ENUM) : EVENT_ENUM).PLAYER_MOVE_END, this.onBurst, this);
        }
        ...
        onBurst() {
          ...
          const isPlayerOnBurst = this.x === playerX && this.y === playerY; // console.log(this.x, playerX, this.y, playerY)
