System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, DirectionSubStateMachine, DIRECTION_ENUM, State, BlockTurnRightSubStateMachine, _crd, BASE_URL;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "86c5dRpZ5NMg6i/8oLqtvEt", "BlockTurnRightSubStateMachine", undefined);

      BASE_URL = 'texture/player/blockturnright';

      _export("default", BlockTurnRightSubStateMachine = class BlockTurnRightSubStateMachine extends (_crd && DirectionSubStateMachine === void 0 ? (_reportPossibleCrUseOfDirectionSubStateMachine({
        error: Error()
...
//# sourceMappingURL=BlockTurnRightSubStateMachine.js.map