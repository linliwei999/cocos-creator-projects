System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, DirectionSubStateMachine, DIRECTION_ENUM, State, BlockLeftSubStateMachine, _crd, BASE_URL;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "e2027B1tkxI8oltfoWrP4FT", "BlockLeftSubStateMachine", undefined);

      BASE_URL = 'texture/player/blockleft';

      _export("default", BlockLeftSubStateMachine = class BlockLeftSubStateMachine extends (_crd && DirectionSubStateMachine === void 0 ? (_reportPossibleCrUseOfDirectionSubStateMachine({
        error: Error()
...
//# sourceMappingURL=BlockLeftSubStateMachine.js.map