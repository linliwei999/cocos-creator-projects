System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, SPIKES_COUNT_ENUM, State, SpikesSubStateMachine, SpikesOneSubStateMachine, _crd, BASE_URL;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("default", SpikesOneSubStateMachine = class SpikesOneSubStateMachine extends (_crd && SpikesSubStateMachine === void 0 ? (_reportPossibleCrUseOfSpikesSubStateMachine({
        error: Error()
