      ...
      _export("WoodenSkeletonManager", WoodenSkeletonManager = (_dec = ccclass('WoodenSkeletonManager'), _dec(_class = class WoodenSkeletonManager extends (_crd && EntityManager === void 0 ? (_reportPossibleCrUseOfEntityManager({
        ...
        init() {
          ...
          return _asyncToGenerator(function* () {
            _this.fsm = _this.node.addComponent(_crd && WoodenSkeletonStateMachine === void 0 ? (_reportPossibleCrUseOfWoodenSkeletonStateMachine({
              error: Error()
            ...
            (_crd && EventManager === void 0 ? (_reportPossibleCrUseOfEventManager({
              ...
              error: Error()
            }), EVENT_ENUM) : EVENT_ENUM).PLAYER_BORN, _this.onChangeDirection, _this);
            (_crd && EventManager === void 0 ? (_reportPossibleCrUseOfEventManager({
              error: Error()
            }), EventManager) : EventManager).Instance.on((_crd && EVENT_ENUM === void 0 ? (_reportPossibleCrUseOfEVENT_ENUM({
              error: Error()
            }), EVENT_ENUM) : EVENT_ENUM).PLAYER_MOVE_END, _this.onChangeDirection, _this);
            (_crd && EventManager === void 0 ? (_reportPossibleCrUseOfEventManager({
              error: Error()
            }), EventManager) : EventManager).Instance.on((_crd && EVENT_ENUM === void 0 ? (_reportPossibleCrUseOfEVENT_ENUM({
              error: Error()
            }), EVENT_ENUM) : EVENT_ENUM).PLAYER_MOVE_END, _this.onAttack, _this);
            (_crd && EventManager === void 0 ? (_reportPossibleCrUseOfEventManager({
              error: Error()
            }), EventManager) : EventManager).Instance.on((_crd && EVENT_ENUM === void 0 ? (_reportPossibleCrUseOfEVENT_ENUM({
              error: Error()
            }), EVENT_ENUM) : EVENT_ENUM).ATTACK_ENEMY, _this.onDeath, _this);

            _this.onChangeDirection(true);
          })();
        }
        ...
        onAttack() {
          ...
          if (this.x === playerX && Math.abs(this.y - playerY) <= 1 || this.y === playerY && Math.abs(this.x - playerX) <= 1) {
            this.state = (_crd && ENTITY_STATE_ENUM === void 0 ? (_reportPossibleCrUseOfENTITY_STATE_ENUM({
              error: Error()
            }), ENTITY_STATE_ENUM) : ENTITY_STATE_ENUM).ATTACK; //玩家切换die状态
